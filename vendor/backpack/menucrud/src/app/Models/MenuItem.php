...
class MenuItem extends Model
{
   ...
   /**
    ...
    protected $fillable = ['name', 'type', 'link', 'page_uuid', 'parent_uuid'];

    public function parent()
    {
        return $this->belongsTo('Backpack\MenuCRUD\app\Models\MenuItem', 'parent_uuid');
    }

    public function children()
    {
        return $this->hasMany('Backpack\MenuCRUD\app\Models\MenuItem', 'parent_uuid');
    }

    public function page()
    {
        return $this->belongsTo('Backpack\PageManager\app\Models\Page', 'page_uuid');
    }
