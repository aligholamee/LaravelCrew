...
class DoorCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/Door');
        $this->crud->setEntityNameStrings('Door', 'Door');
        ...
        */
        ...
        if(array_key_exists('house_uuid', $_GET)) {
            // There exists a house_uuid
            // Do this!
